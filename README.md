...
steps and sometimes go under; rimstone terraces — calcite dams holding clear pools, stepping down; black lakes in big chambers that you wade into, swim across in the cold, and wade out of; windows — a second hole to the sky in a shallow chamber roof, with rain and roots and birds and no way up it; bat roosts; olms in the still pools, pale and blind, that flinch from the beam; mineral tints by region; bones, and the packs of the cavers who left them.
